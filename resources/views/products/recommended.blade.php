<x-client-layout title="Recommended Products - AutoPartsX">
  <!-- Hero Section -->
  <div class="bg-linear-to-r from-blue-100 px-4 sm:px-6 lg:px-12 flex justify-between items-center via-blue-50 to-emerald-50 border-b border-blue-200/70 py-14 shadow-sm">
