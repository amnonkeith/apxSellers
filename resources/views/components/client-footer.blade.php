...
<footer class="bg-slate-900 text-white mt-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <p class="text-slate-400 text-sm mb-4">
          Your trusted source for quality auto parts. We provide OEM and aftermarket parts for all vehicle makes and models.
        </p>
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-slate-400">
          <li><a href="/products" class="hover:text-emerald-400 transition-colors">All Products</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-slate-400">
          <li><a href="/shipping" class="hover:text-emerald-400 transition-colors">Shipping Info</a></li>
          <li><a href="/returns" class="hover:text-emerald-400 transition-colors">Returns</a></li>
          <li><a href="/warranty" class="hover:text-emerald-400 transition-colors">Warranty</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-slate-400">
          ...
          <li class="flex items-start">
            ...
            <span>support@autopartsx.com</span>
          </li>
          <li class="flex items-start">
            <i class="fas fa-map-marker-alt mr-2 mt-1"></i>
            <span>123 Auto Parts St, City, State 12345</span>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="border-t border-slate-800 mt-8 pt-8 text-center text-sm text-slate-400">
      <p>&copy; {{ date('Y') }} AutoPartsX. All rights reserved.</p>
    </div>
  </div>
</footer>
